...
> You can check out the [live-slideshow.vercel.app](https://live-slideshow.vercel.app/) demo (from [Live Slideshow](https://github.com/farnaz-kakhsaz/live-slideshow) repository) that was created to show this library's potentials in action.
